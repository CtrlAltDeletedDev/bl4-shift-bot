                ...
                for row in rows[1:]:  # Skip header row
                    ...
                    if len(cells) >= 3:
                        ...
                        if (
                            ...
                            and code_text.count("-") >= 4
                        ):
                            # Skip placeholder entries
                            if code_text.lower() not in [
                                "coming soon",
                                "…",
                                "tba",
                                "tbd",
                                ...
                                codes.append(
                                    ShiftCode(
                                        ...
                                        if expires_text and expires_text != "…"
                                        else None,
                                        source="MentalMars",
                                    )
                                )
    ...
    async def scrape_xsmashx88x(self) -> List[ShiftCode]:
        ...
        try:
            ...
            code_elements = soup.find_all(
                ["div", "span", "code", "pre"],
                class_=lambda x: x
                and ("code" in x.lower() if isinstance(x, str) else False),
            )
            ...
            if not codes:
                ...
                for code_text in matches:
                    if code_text not in placeholders and code_text not in [
